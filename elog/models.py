...
class Board(models.Model):
  ...
  batch_id = models.CharField(max_length=200, null=True, blank=True, help_text="Enter 5-character batch id (format: AAA00)")
  date_code = models.IntegerField(null=True, blank=True, help_text="Enter 4-digit date code")
  serial_number = models.IntegerField(null=True, blank=True, help_text="Enter the serial number labeled SN")
